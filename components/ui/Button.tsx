...
const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    primary: "bg-[#05050A] text-white shadow-firm hover:bg-[#1e293b] dark:bg-firm-accent/10 dark:text-firm-accent dark:ring-1 dark:ring-inset dark:ring-firm-accent/20 dark:hover:bg-firm-accent/20 dark:shadow-none",
