          ...
          <div className="flex flex-col">
            ...
            <div className="space-y-3 flex-1 flex flex-col">
              <input
                ...
                className="w-full p-3.5 rounded-xl bg-firm-paper/50 border border-firm-slate/15 text-sm focus:border-firm-accent focus:ring-2 focus:ring-firm-accent/30 text-firm-navy font-bold shadow-[inset_0_2px_4px_rgba(0,0,0,0.02)] transition-all outline-none"
                value={audience}
